...
* **Ships that I’m okay to interact with:** ArdaminA (Endfield), Chili (Genshin) (Friends only), Haikaveh (Genshin) (Strictly Friends only), Caeheng (HSR), Renfeng (HSR) (Friends only), ShiGuang (Link Click), JaeXiao (Link Click) other ships, whisper if unsure (directed at friends and strangers).
